...
C *****  LOCAL VARIABLES.  *****
C
      REAL (KIND=R8):: DCALC,DD001,DD0011,DD01,DD011,DELS,F0,F1,xxx,
...
C COMPUTED ON LAST CALL TO  STEPNF .
      ...
      DO J=1,NP1
        xxx=HOLD+H
        W(J)=QOFS(YOLD(J),YPOLD(J),Y(J),YP(J),HOLD,xxx)
      END DO
      Z0=W 
C
C ***** END OF PREDICTOR SECTION. *****
...
C
     ...
     &  HFAIL,HT,LCALC,RCALC,TEMP,TWOU,xxx
...
C
     ...
     &  GAMMA, HFAIL, HTEMP, IDLERR, OMEGA, P0, P1, PP0, PP1, xxx,
...
C
          DO I=1,NP1
        xxx=HOLD+H
            Z0(I) = QOFS(YOLD(I),YPOLD(I),Y(I),YP(I),HOLD,xxx) 
          END DO
        END IF
C
C ***** END OF PREDICTOR SECTION. *****
...
C
      ...
      ELSE
        DO I=1,NP1
        xxx=HOLD+H
          DZ(I)=QOFS(YOLD(I),YPOLD(I),Y(I),YP(I),HOLD,xxx)
        END DO
      ENDIF
      DZ = DZ - Z0

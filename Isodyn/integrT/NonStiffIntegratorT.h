...
class insT: public NonStiffIntegratorT {
public:
      insT(const int nin, double yin[], double xin, double xendin, double dxin,
		int nrdens, int itolerin = 0, double *rtolerin = 0, double *atolerin = 0,
		const int ioutin = 2, double hin = 0.0, double hmaxin = 0.0, int nmaxin = 0.0,
		double uroundin = 0.0, double safein = 0.0, double faclin = 0.0,
		double facrin = 0.0, double betain = 0.0, int nstiffin = 0,
		unsigned *icontin = NULL) : NonStiffIntegratorT (nin,  yin,  xin,  xendin,
dxin, nrdens,  itolerin, rtolerin, atolerin,	ioutin,  hin,  hmaxin,  nmaxin,  uroundin,
safein,  faclin,  facrin,  betain, nstiffin, icontin  ) {}

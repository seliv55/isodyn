...
extern const int nh6, nfbp, nt3, npep, npyr, npyrm, ncoa, ncoac, nagl, noa, noac, ncit, ncitc, nakg, nakgc, nfum, nmal, np5, ne4, ns7, ncthf, n_atp, n_nad, numx, ngl, nlac, nglu, ngln, nala, nasp, nser, ngly, npro, nrna, nmet;

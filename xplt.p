set t pngcairo enhanced dashed font "arial,12" size 1000,300; set output "figs/con.png";
...
do for [n=1:5]{
plot 'edata' u 1:(column(n*2)) w p pt 3 t columnhead(n*2), 'kinGlc' u 1:(column(n+1)) w l
  }
unset multiplot;

...
void derivs_s(const DP x, Vec_IO_DP &y, Vec_O_DP &dydx);
...
void jacobn_s(const DP x, Vec_IO_DP &y, Vec_O_DP &dfdx, Mat_O_DP &dfdy);
...
void odeint(Vec_IO_DP &ystart, const DP x1, const DP x2, const DP eps,
	...
	Vec_I_DP &, DP &, DP &, void (*)(const DP, Vec_IO_DP &, Vec_O_DP &)));
...
void rk4(Vec_I_DP &y, Vec_I_DP &dydx, const DP x, const DP h,
	Vec_O_DP &yout, void derivs(const DP, Vec_IO_DP &, Vec_O_DP &));
...
void sort2a(Vec_IO_DP &arr, Vec_IO_INT &brr);
